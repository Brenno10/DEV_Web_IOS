...
// Para criar `` segura shift usando o acento á
...
console.log(typeof numArray); // typeof diz oque é o valor indicado
...
// pop() remove o ultimo elemento do array e retorna o elemento tirado
console.clear();
...
// shift() remove o elemento no início do array deslocando todos os elementos em uma posição e retorna esse elemento retirado
console.clear();
...
// unshift() insere um elemento no início do array e retorna o tamanho do novo array
console.clear();
...
// O comando delete apaga um elemento na posição desejada e altera para slot vazio, que é o mesmo de undefined
console.clear();
